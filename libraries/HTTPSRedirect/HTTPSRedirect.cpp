...
void HTTPSRedirect::fetchData(bool disp, bool header){
  ...
  while (connected()) {
    ...
    if (disp){
	  ...
	  if(line == "A1\r"){
            Serial.println("LED1: ");    //lcd1.setCursor(0, 3); lcd1.print("       ");
            Serial.println(line);   	//lcd1.setCursor(0, 3); lcd1.print("LED1: "); lcd1.print("ON");
	  ...
	  if(line == "A0\r"){
            Serial.println("LED1: ");  //lcd1.setCursor(0, 3); lcd1.print("       ");
            Serial.println(line);     //lcd1.setCursor(0, 3); lcd1.print("LED1: "); lcd1.print("OFF");
