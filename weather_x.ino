 ...
 * Tools
  ...
  4.LCD20x4.SDA--D2
           ...
           .VCC--VV (5V only)
  5.LED--D0,GND
  6.Switch--D5(GPIO14),D6(GPIO12)  //cannot uplode and cannot wake after power off if use D4(GPIO2)
          --GND
          --3.3V
...
#define LINE_TOKEN "fNq6PhPZWDVlYrA5GpfLhyXXHAcD3yw7ueuU4lAEebb"  //--------------------------------
...
void setup() {
  ...
  attachInterrupt(12, doIn2,RISING);  //GPIO12
  attachInterrupt(14, doIn14,FALLING);  //GPIO14
...
void loop() {
  ...
  if(temp < 27){      flag = White;     fla = "Green";   water = "1/2"; }
...
//*************---LCD---***************************************************************
  ...
  Serial.println("Humid : \t"); Serial.println(humid);  lcd.setCursor(0, 1); lcd.print("Humid : "); lcd.print(humid);
  Serial.println("Temp : \t"); Serial.println(temp);     lcd.setCursor(0, 2); lcd.print("Temp  : "); lcd.print(temp);
  Serial.println("Flag : \t"); Serial.println(flag);  lcd.setCursor(0, 3); lcd.print("Flag  : "); lcd.print(fla);
